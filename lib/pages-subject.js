...
<div class="meta"><span class="tag">📍 ${list.length}개 시군구</span><span class="tag">${total.toLocaleString()}개 동·읍·면</span><span class="tag">${s.adult ? '성인·청소년' : '초·중·고 전 학년'}</span><span class="tag">📞 ${SITE.tel}</span></div>${updHtml()}
...
<div class="meta"><span class="tag">📍 ${dongs.length}개 동·읍·면</span><span class="tag">${s.adult ? '성인·청소년' : '초·중·고 전 학년'}</span><span class="tag">방문·화상</span><span class="tag">📞 ${SITE.tel}</span></div>${updHtml()}
...
<div class="meta"><span class="tag">📍 ${esc(g.name)} ${esc(d.name)}</span><span class="tag">${s.adult ? '성인·청소년' : '초·중·고 전 학년'}</span><span class="tag">방문·화상</span><span class="tag">📞 ${SITE.tel}</span></div>${updHtml()}
...
${subjectBox(key, `${prefix}/${gradeKey}`)}
